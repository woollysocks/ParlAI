...
from parlai.mturk.tasks.game3.worlds import (
    OnboardingWorld,
    MultiRoleAgentWorld,
)
from parlai.mturk.core.mturk_manager import MTurkManager
from parlai.mturk.tasks.game3.task_config import (
    task_config,
)
import os
import importlib
...
def main():
    ...
    assert (task_opt['num_workers'] % 2 == 0 and task_opt['num_workers'] >= 2), "The game only supports even number of workers, with a minimum of 4 people."
